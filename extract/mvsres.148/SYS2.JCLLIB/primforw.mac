...
//********************************************************************
//*
//* Name: SYS2.JCLLIB(PRIMFORW)
//*
//* Desc: Sieve of Eratosthenes programmed in FORTRAN,
//*       compiled using the Waterloo University WATFIV V1L5 compiler.
//*       All prime numbers up to the value entered after
//*       $ENTRY are computed.
//*
//********************************************************************
//PRIMES   EXEC WATFIV
...
//SYSIN       DD *
$JOB           ERATOSTHENES,TIME=(1440),NOCHECK
C /*-----------------------------------------------------------------*/
...
4     FORMAT (  3X, I7, 1X, I7, 1X, I7, 1X, I7, 1X, I7, 1X, I7, 1X, I7,
     ...
     1, I7, 1X, I7, 1X, I7)
5     FORMAT (' Sieve of Eratosthenes generated using Waterloo WATFIV V1
     1L5')
