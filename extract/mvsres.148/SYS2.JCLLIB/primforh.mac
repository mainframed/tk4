...
//********************************************************************
//*
//* Name: SYS2.JCLLIB(PRIMFORH)
//*
//* Desc: Sieve of Eratosthenes programmed in FORTRAN,
//*       compiled using the IBM OS/360 FORTRAN H Level 21.8 compiler.
//*       All prime numbers up to the value entered via
//*       //GO.SYSIN DD are computed.
//*
//********************************************************************
//PRIMES    EXEC FORTHCLD,PARM.GO='SIZE=9000000'
//FORT.SYSIN DD *
C /*-----------------------------------------------------------------*/
...
4     FORMAT (  3X, I7, 1X, I7, 1X, I7, 1X, I7, 1X, I7, 1X, I7, 1X, I7,
     ...
     1, I7, 1X, I7, 1X, I7)
5     FORMAT (' Sieve of Eratosthenes generated using OS/360 FORTRAN H L
     1evel 21.8')
