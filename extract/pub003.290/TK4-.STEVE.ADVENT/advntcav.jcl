//ADVNTCAV JOB CLASS=A,MSGCLASS=A,MSGLEVEL=(1,1)
//ADDMEM   EXEC PGM=IEBUPDTE,REGION=128K
//SYSPRINT DD  SYSOUT=A
//SYSUT1   DD  DISP=SHR,DSN=STEVE.MY.CNTL   <<< CHECK DSNAME
//SYSUT2   DD  DISP=SHR,DSN=STEVE.MY.CNTL   <<< CHECK DSNAME
//SYSIN    DD  DATA
./       ADD   NAME=ADVNTCAV
1
